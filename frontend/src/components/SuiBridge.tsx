...
import { useInitBridge } from '@/hooks/useApi'
...
export function SuiBridge() {
    ...
    const initBridge = useInitBridge()
    ...
    useEffect(() => {
        const fetchUsdcBalance = async () => {
            if (!suiAccount?.address || !suiClient) return
            ...
            try {
                ...
                const total = coins.data.reduce((acc, coin) => {
